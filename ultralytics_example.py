...
ZONE_IN_POLYGONS = [
    np.array([[48, 364], [554, 364],  [554, 498], [48, 498]]),
    np.array([
        [1623, 609],    # Top-left corner
        [1898, 609],    # Top-right corner
        [1898, 782],    # Bottom-right corner (previously Bottom-left)
        [1623, 782]     # Bottom-left corner (previously Bottom-right)
    ])
]

ZONE_OUT_POLYGONS = [
    np.array([
        [27, 547],    # Top-left corner
        [485, 547],   # Top-right corner
        [485, 772],
        [27, 772]

    ]),
    np.array([
        [1533, 174],    # Top-left corner
        [1884, 174],    # Top-right corner
        [1884, 589],     # Bottom-right corner
        [1533, 589],    # Bottom-left corner
        ...
        for zone_out_id, zone_out in enumerate(self.zones_out):
            ...
            if zone_out_id in self.detections_manager.counts:
                ...
                for i, zone_in_id in enumerate(counts):
                    count = len(
                        self.detections_manager.counts[zone_out_id][zone_in_id])
